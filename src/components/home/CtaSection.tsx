...
const CtaSection = () => {
  ...
  return (
    <section className="section-padding bg-civitas-dark text-white">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-block px-3 py-1 bg-civitas-secondary/20 text-civitas-secondary rounded-full text-sm font-medium mb-4">
              Start Today
            </span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="bg-civitas-primary hover:bg-civitas-primary/90">
            ...
            <div className="mt-8 pt-8 border-t border-white/20">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex gap-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-civitas-primary transition-colors">
          ...
          <div className="rounded-lg overflow-hidden shadow-xl hidden lg:block">
            <img 
