    ...
    <section className="relative bg-gradient-to-br from-civitas-light to-white min-h-[90vh] flex items-center">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden md:block relative animate-fade-in" style={{ animationDelay: '0.8s' }}>
            <div className="relative overflow-hidden rounded-lg shadow-xl">
              <img 
                src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80" 
                alt="Professional African electrician at work" 
                className="w-full h-auto object-cover rounded-lg"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-civitas-primary/40 to-transparent"></div>
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="inline-block px-4 py-2 bg-civitas-primary text-white rounded-full text-sm font-medium">
                  Expert Electricians
                </div>
              </div>
            </div>
